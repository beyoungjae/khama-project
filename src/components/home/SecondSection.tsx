   ...
   return (
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
         ...
         <div 
            ...
            style={{ backgroundImage: `url(https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1920&h=1080&fit=crop)` }}
         />
         ...
         <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
            <div className="animate-fade-in-up">
               ...
               <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a 
                     href="/business"
                     className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300"
                  >
                     자격증 신청
                  </a>
               </div>
